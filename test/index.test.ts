...
import { getRegistrySingleton, ModuleRegistry } from '../src/index';
...
describe('Module Registry', function() {
  ...
  describe('Registering modules', function() {
    it('should be able to register module', function() {
      ...
      expect(registry.getModule('test2')).to.deep.equal({ id: 'test2' });
      expect(modules).to.deep.equal([{ id: 'test1' }, { id: 'test2' }]);
    ...
    it('should be able to get modules with getModules function', function() {
      ...
      expect(test2).to.deep.equal({ id: 'test2' });
    });
